...
echo "  hf upload lydorianP/samuel-custom $CKPT --repo-type model"
echo "  hf upload lydorianP/samuel-custom ${CKPT%.pt}.json --repo-type model  # if you have custom_config.json"
